...
double sinus(double base) { return sin(base); }

double sinus(int base) { return sin(static_cast<double>(base)); }
...
double sinush(double base) { return sinh(base); }

double sinush(int base) { return sinh(static_cast<double>(base)); }
...
double asinus(double base) { return asin(base); }

double asinus(int base) { return asin(static_cast<double>(base)); }
...
double cosinus(double base) { return cos(base); }

double cosinus(int base) { return cos(static_cast<double>(base)); }
...
double acosinus(double base) { return acos(base); }

double acosinus(int base) { return acos(static_cast<double>(base)); }
...
double cosinush(double base) { return cosh(base); }

double cosinush(int base) { return cosh(static_cast<double>(base)); }
...
double tangens(double base) { return tan(base); }

double tangens(int base) { return tan(static_cast<double>(base)); }
...
double atangens(double base) { return atan(base); }

double atangens(int base) { return atan(static_cast<double>(base)); }
...
double tangensh(double base) { return tanh(base); }

double tangensh(int base) { return tanh(static_cast<double>(base)); }
